...
var Game = function(){
	...
	this.update = function(){
		...
		if(FPS === 30){
			setTimeout(function(){game.update();}, 1000 / FPS);
		}
	}
...
Game.prototype.title = function(){
	...
	this.canvas = document.querySelector('#GoDownStair');
	...
	this.title = setTimeout(function(){
		game.ctx.drawImage(image.title, 0, 0, game.width, game.height);
		game.draw('start', game.width / 3, game.height / 3, game.width / 3, game.height / 15);
		game.ctx.drawImage(image.arrow, game.width / 4, game.height / 3 - 2, game.height / 15, game.height / 15);
	}, 50)
}
...
window.onload = function(){
	var sprites = {
		...
		girl : "./image/girl.png",
		character_panel : "./image/character_panel2.jpg",
